...
class RBTree:
    ...
    def rotate_left(self, pivot_parent):
        if pivot_parent.parent == self.nil or pivot_parent.right == self.nil:
            return
        pivot = pivot_parent.right
        pivot_parent.right = pivot.left 
        if pivot.left != self.nil:
            pivot.left.parent = pivot_parent
        pivot_parent = pivot_parent.parent
    ...
    def rotate_right(self, pivot_parent):
        if pivot_parent.parent == self.nil or pivot_parent.left == self.nil:
            return
